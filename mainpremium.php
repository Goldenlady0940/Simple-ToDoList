...
<div class="events">
  ...
  if(isset($_POST['goto-btn'])){
    ...
    <div class="task-display <?php echo $class; ?>" >
      ...
      <div class="del-btn"><button onclick="location.href='premdelete.php?id=<?= $row2['TaskID']; ?>';"><i class="fa fa-trash" aria-hidden="true"></i></button></div>
    </div>
    </div>
    <?php
    }
 ...
 if(isset($_POST['filter-btn'])){
    ...
    if($row3['Status'] == 1){
      ...
      <div class="stat" onclick="location.href='peditstat.php?id=<?= $row2['TaskID']; ?>';"><?php echo $sdes; ?></div>
        ...
        <div class="del-btn"><button onclick="location.href='premdelete.php?id=<?= $row3['TaskID']; ?>';"><i class="fa fa-trash" aria-hidden="true"></i></button></div>
      </div>
    </div>
    <?php
    }
